...
@Schema(description = "A single setting for an application installed and used on mobile device and used in data "
...
public class SyncApplicationSetting implements Serializable, SyncApplicationSettingInt {
    ...
    @Schema(description = "A type of the application setting. 1 - String, 2 - Integer, 3 - Boolean",
            requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "1,2,3")
    private int type;
    ...
    @Schema(description = "A flag indicating if setting has variable content", requiredMode = Schema.RequiredMode.REQUIRED)
