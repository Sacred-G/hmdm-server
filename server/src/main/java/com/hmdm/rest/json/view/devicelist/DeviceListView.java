...
/**
 * <p>A DTO carrying the details for <code>Device List</code> view.</p>
 *
 * @author isv
 */
...
public class DeviceListView implements Serializable {
    ...
    /**
     * <p>A mapping from configuration IDs for configurations data. Lists the configurations referenced from the provided devices.</p>
     */
