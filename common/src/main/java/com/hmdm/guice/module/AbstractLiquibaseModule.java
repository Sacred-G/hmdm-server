...
public abstract class AbstractLiquibaseModule extends AbstractModule {
    ...
    /**
     * <p>Configures this module. Applies the recent changes from the {@link #getChangeLogResourcePath()} change log to database.</p>
     */
    ...
    /**
     * <p>Gets the path to the DB change log to be used by this module.Plugins MUST override this method to provide the path to specific Db change
     * log.</p>
     *
