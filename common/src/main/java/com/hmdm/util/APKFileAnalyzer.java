...
public class APKFileAnalyzer {
    ...
    /**
     * Detect native-code ABIs by scanning lib/<abi>/ Returns null for universal APK, or arch label for a single-arch APK
     */
    ...
    /**
     * <p>A consumer for the stream contents. Outputs the line read from the stream and passes it to provided line consumer.</p>
     */
