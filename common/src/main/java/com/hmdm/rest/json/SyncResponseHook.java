...
/**
 * <p>An interface for the hooks to be executed when a response to device configuration synchronization request is going to be sent to device. The
 * hooks may extend the response with additional properties or perform any other desired actions based on provided response.</p>
 *
 * @author isv
 */
