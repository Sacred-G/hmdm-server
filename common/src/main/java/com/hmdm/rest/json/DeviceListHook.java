...
/**
 * <p>An interface for the hooks to be executed when a device list is going to be returned to client. The hooks may extend the device objects with
 * additional properties or perform any other desired actions based on provided response.</p>
 *
 * @author isv
 */
