...
/**
 * <p>An exception to be thrown in case there is an attempt to create or update an application while another application with same package ID and
 * version already exists.</p>
 *
 * @author isv
 */
