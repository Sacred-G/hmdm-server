...
public class CommonDAO extends AbstractDAO<Settings> {
    ...
    /**
     * This function doesn't check the security context because it's called when a customer is signed up There's a call of this method in
     * UnsecureDAO.signupCustomerUnsecure() So the security context check should be performed in the calling function!!!
     *
     * @param settings
     */
