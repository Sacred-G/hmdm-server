...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "Customer{" + "id=" + id + ", name='" + name + '\'' + ", email='" + email + '\''
                + ", description='" + description + '\'' + ", filesDir='"
                + filesDir + '\'' + ", master=" + master + ", prefix=" + prefix
                + ", deviceConfigurationId=" + deviceConfigurationId + ", accountType="
                + accountType + ", deviceLimit=" + deviceLimit + ", sizeLimit="
                + sizeLimit + ", customerStatus='" + customerStatus + '\''
                + ", firstName='" + firstName + '\'' + ", lastName='" + lastName + '\''
                + ", language='" + language + '\'' + ", inactiveState=" + inactiveState
                + ", pauseState=" + pauseState + ", abandonState=" + abandonState
                + ", signupStatus=" + signupStatus + ", signupToken=" + signupToken + '}';
    }
}
