...
public class UserRoleSettings implements CustomerData, Serializable {
    ...
    public String toString() {
        return "UserRoleSettings{" + "id=" + id + ", customerId=" + customerId + ", roleId=" + roleId
                + ", columnDisplayedDeviceStatus=" + columnDisplayedDeviceStatus + ", columnDisplayedDeviceDate="
                + columnDisplayedDeviceDate + ", columnDisplayedDeviceNumber=" + columnDisplayedDeviceNumber
                ...
                + ", columnDisplayedDeviceImei=" + columnDisplayedDeviceImei + ", columnDisplayedDevicePhone="
                + columnDisplayedDevicePhone + ", columnDisplayedDeviceDesc=" + columnDisplayedDeviceDesc
                + ", columnDisplayedDeviceGroup=" + columnDisplayedDeviceGroup + ", columnDisplayedLauncherVersion="
                + columnDisplayedLauncherVersion + ", columnDisplayedBatteryLevel=" + columnDisplayedBatteryLevel
                + ", columnDisplayedDefaultLauncher=" + columnDisplayedDefaultLauncher + ", columnDisplayedMdmMode="
                + columnDisplayedMdmMode + ", columnDisplayedKioskMode=" + columnDisplayedKioskMode
                + ", columnDisplayedAndroidVersion=" + columnDisplayedAndroidVersion
                + ", columnDisplayedEnrollmentDate=" + columnDisplayedEnrollmentDate + ", columnDisplayedSerial="
                + columnDisplayedSerial + ", columnDisplayedPublicIp=" + columnDisplayedPublicIp
                + ", columnDisplayedCustom1=" + columnDisplayedCustom1 + ", columnDisplayedCustom2="
                + columnDisplayedCustom2 + ", columnDisplayedCustom3=" + columnDisplayedCustom3 + '}';
    }
}
