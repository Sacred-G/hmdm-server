...
public class AuditFilter implements Filter {
    ...
    /**
     * <p>Intercepts the specified request/response chain and records the audit data if auditing for specified request is supported.</p>
     */
    @Override
    ...
    private class Task implements Runnable {
        ...
        /**
         * <p>Inserts the audit log record into database.</p>
         */
        @Override
        public void run() {
            try {
