...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Info</code> plugin.</p>
 *
 * @author isv
 */
public class DeviceInfoLiquibaseModule extends AbstractLiquibaseModule {
    ...
    protected String getChangeLogResourcePath() {
        ...
        return "liquibase/deviceinfo.changelog.xml";
    }
