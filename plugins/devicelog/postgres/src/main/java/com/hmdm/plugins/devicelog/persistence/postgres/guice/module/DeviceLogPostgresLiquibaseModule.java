...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Log</code> plugin backed by
 * <code>Postgres</code> database.</p>
 *
 * @author isv
 */
