...
/**
 * <p>A module used to bind the service interfaces to specific implementations provided by the <code>Postgres</code> persistence layer for
 * <code>Device Log</code> plugin..</p>
 *
 * @author isv
 */
public class DeviceLogPostgresServiceModule extends AbstractModule {
    ...
    /**
     * <p>Configures the services exposed by the <code>Postgres</code> persistence layer for <code>Device Log</code> plugin.</p>
     */
    @Override
